...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    View dialogView;
    TextView Tv_Id, Tv_Nama, Tv_TempatLahir, Tv_JK, Tv_Tanggal, Tv_Alamat;
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:
                        ...
                        Tv_Id.setText("Kode Member: " + cur.getString(cur.getColumnIndex(DBHelper.row_id)));
